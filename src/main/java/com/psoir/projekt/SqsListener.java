...
public class SqsListener {
	...
	public static final String domainName = "Karpish";
	public static final String DATE = "Date";
	private static final String ITEM_NAME = "Item_Name";
	public static final String HTTPS_SQS_US_WEST_2_AMAZONAWS_COM = "https://sqs.us-west-2.amazonaws.com/860901660784/karpishsqs";
	...
	public SqsListener() {
		AWSCredentials credentials = new BasicAWSCredentials("AKIAIQ37CQXHJL46QTQA",
				"xUhO1meQLvt5thnOW3WgNOkOgS6vT6vy26+uFrfy");
		this.queName = "karpishsqs";
